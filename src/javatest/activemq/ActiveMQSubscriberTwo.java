...
public class ActiveMQSubscriberTwo implements MessageListener{
    public void Subscribe() {
        try {
            ...
            connection.start();
            System.out.println("Two subscribed to topic");
    ...
    public void onMessage(Message message) {
        try {
            ...
            System.out.println("Subscriber Two Listener:"+text);
